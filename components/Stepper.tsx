          ...
          >
            {stepIdx < currentStep ? (
              <>
                ...
                <a
                  href="#"
                  className="relative flex h-8 w-8 items-center justify-center rounded-full bg-teal-600 hover:bg-teal-700"
                >
                  <svg
             ...
             <span className="absolute top-10 w-max -ml-2 text-xs font-semibold text-gray-600">
                {step}
             </span>
          </li>
        ))}
