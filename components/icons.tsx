...
export const LogoIcon: React.FC<{ className?: string }> = ({ className = "h-8 w-8 text-blue-500" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M8 3H14.5C17.5 3 19 4.5 19 7.5C19 10.5 17.5 12 14.5 12H8V3Z" fill="currentColor"/>
        <path d="M8 12H15L19 21H12L8 12Z" fill="currentColor" opacity="0.7"/>
        <path d="M8 3V21H5V3H8Z" fill="currentColor"/>
    </svg>
);

export const FileUploadIcon: React.FC<{ className?: string }> = ({ className = "w-10 h-10" }) => (
